...
public class ADTAdmissionForm_WIth_Reg_with_Insurance 
{
	WebDriver driver;
	...
	//Payer Type
	By PayerTypeClick=By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-admission-form/mat-drawer-container/mat-drawer-content/div/div[1]/div[2]/mat-tab-group/div/mat-tab-body[1]/div/app-payer-list/div/div[2]/table/tbody/tr[1]/td[2]/mat-select");
	...
	public void ADT_Admission_Form_with_Insurance(String LengthOfStayPar,String AdmittingDiagPar,String AddNotesPar,String PatientNotesPar,String AdmissionRemarksPar,String BillEstimationPar,String ReferralRemarksPar,String NamePar,String IdentificationNOPar,String PhoneNumberPar,String AddressPar,String ZipCodePar) throws InterruptedException, IOException
	{
		...
		//Admission Time
		Thread.sleep(2000);
		driver.findElement(AdmissionTimeClick).sendKeys("10:00AM");
		...
		FileUtils.copyFile(screenshot7,new File(".//ScreenShots//ADTAdmissionForm_WIth_Reg_with_Insurance.png"));

	}

	public ADTAdmissionForm_WIth_Reg_with_Insurance(WebDriver driver)
	{
		this.driver=driver;
	}
