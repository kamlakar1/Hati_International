...
public class GLApproval_ADT_Requested_FOR_IP_Charge_IP_BILL_Apply_GRoupDiscount {
...

	{
		...
		WebElement Clear1 = driver.findElement(GroupDiscountClick);
		...
		FileUtils.copyFile(screenshot2, new File(".//ScreenShot//IPD_Bill.png"+ dateFormat.format(nowdate)));
