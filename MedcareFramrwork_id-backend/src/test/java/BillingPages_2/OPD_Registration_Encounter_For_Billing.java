...
public class OPD_Registration_Encounter_For_Billing 
{
	...
	driver.findElement(RelationSelOpt).click();
		...
		String Actual_1=NamePar;
        String Expected_1 = NamePar;
        Assert.assertEquals(Actual_1, Expected_1, "Patient Has Been Successfully created");
        Thread.sleep(1000);
        File screenshot3 = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
        String timestamp3= new SimpleDateFormat("yyyy_MM_dd__hh_mm_ss").format(new Date());
        FileUtils.copyFile(screenshot3, new File(".//ScreenShots//Failed_OPD_Registration_Encounter_For_Billing.png"+timestamp3));
        Thread.sleep(3000);
	}
	public OPD_Registration_Encounter_For_Billing (WebDriver driver)
	{
		this.driver=driver;
	}
}
