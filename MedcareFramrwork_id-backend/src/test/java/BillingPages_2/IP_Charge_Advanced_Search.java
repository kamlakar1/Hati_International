...
public class IP_Charge_Advanced_Search 
{
	WebDriver driver;
	...
	public void IPChargeAdvancedCharge() throws InterruptedException, IOException
{
	...
	public IP_Charge_Advanced_Search(WebDriver driver)
	{
		this.driver=driver;
	}
}
