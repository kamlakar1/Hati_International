...
public class GLApproval_ADT_Requested_FOR_IP_Charge_IP_BILL_Apply_Discount {
	...
	//Radio Button
	By RadioButtonClick=By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-gl-approval/app-patient-search/div/div/div/table/tbody/tr[1]/td[1]/div/mat-radio-button/label/span[1]/span[3]");
...

	{
		...
		Thread.sleep(2000);		
		WebElement Clear1 = driver.findElement(DiscountClick);
