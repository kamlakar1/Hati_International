...
public class IP_Bill_For_Self_OutStanding 
{
	WebDriver driver;
	...
	public void IPDBillForSelPayerOutStanding() throws InterruptedException, IOException
	{
	...
	public IP_Bill_For_Self_OutStanding(WebDriver driver)
	{
		this.driver=driver;
	}
}
