...
public class Credit_Note_Against_Discount_All_service_Partial_settlement {
	...
	By discountCategory=By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-opdbill/div[4]/div/div/div[1]/div/div/mat-grid-list[1]/div/mat-grid-tile[3]");
	...
	public Credit_Note_Against_Discount_All_service_Partial_settlement(WebDriver driver)
	...
	public void Credit_Note_Against_Discount_All_service_Partial_settlementfunc(String QuickPrimaryIdNumberPar,String QuickExparyDatePar,String QuickDateOfBirthPar,String QuickMobileNumberPar,String QuickEncounterRemarksPar,String QuickAddNotesPar,String QuickEncounterNotesPar,String QuickPatientNotesPar,String QuickReferralRemarksPar,String ServiceNamePar,String ServiceName2Par,String ReceivedFromPar,String IdentificationNoPar,String RemarksPar) throws InterruptedException, IOException, AWTException 

	{
		...
		FileUtils.copyFile(screenshot, new File(".//ScreenShots//Credit_Note_Against_Discount_All_service_Partial_settlement_QuickRegisterationForm.png")); 
		...
		FileUtils.copyFile(screenshot1, new File(".//ScreenShots//Credit_Note_Against_Discount_All_service_Partial_settlement_EncounterListScreen.png")); 
		...
		FileUtils.copyFile(screenshot23, new File(".//ScreenShots//Credit_Note_Against_Discount_All_service_Partial_settlement_ChargesSave.png"));
		Thread.sleep(3000);
		...
		Thread.sleep(4000);
		driver.findElement(PartialAmount).sendKeys("1.00");
		...
		FileUtils.copyFile(screenshot24, new File(".//ScreenShots//Credit_Note_Against_Discount_All_service_Partial_settlement_Final_Bill.png"));
		Thread.sleep(3000);
		...
		FileUtils.copyFile(screenshot3, new File(".//ScreenShots//Credit_Note_Against_Discount_All_service_Partial_settlement_Bill_Summary.png")); 


		//SideMenuBar
		//Actions act = new Actions(driver);
		Thread.sleep(3000);
		WebElement SidebarMenu_1=driver.findElement(SideBar);
		act.moveToElement(SidebarMenu_1).build().perform();
		...
		Thread.sleep(2000);
		//	WebElement MRNSearch=driver.findElement(CreatedMRN);
		//	String MRNS_1=MRNSearch.getText();
		...
		FileUtils.copyFile(screenshot7, new File(".//ScreenShots//Credit_Note_Against_Discount_All_service_Partial_settlement_search_mrn.png")); 
		...
		FileUtils.copyFile(screenshot9, new File(".//ScreenShots//Credit_Note_Against_Discount_All_service_Partial_settlement.png")); 
		Thread.sleep(1000);
	...
	//	driver.findElement(checkAllServices).click();
		...
		String Actaul = "Credit Note has been saved Succesfully";
		String Expected = "Credit Note has been saved Succesfully";
		Assert.assertEquals(Actaul, Expected,"Credit Note has been saved Succesfully");
		Thread.sleep(2000);


		File screenshot_8 = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
		FileUtils.copyFile(screenshot_8, new File(".//ScreenShots//Credit_Note_Against_Discount_All_service_Partial_settlement.png")); 
		Thread.sleep(2000);
	}
}
