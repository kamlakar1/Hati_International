package BillingPages.RefundSelf;
...
public class OP_Patient_Self_Refund_Against_Account_Page {
...
//---Refund---//
		...
		//AvailableBalance
		By AvailableBalance=By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-refund-against-deposit/div[3]/div[3]/form/mat-grid-list/div/mat-grid-tile[1]/div/mat-form-field/div/div[1]/div[3]/input");
		...
		public OP_Patient_Self_Refund_Against_Account_Page (WebDriver driver)
  ...
  
  {
			...
			//------Deposit-----//
				...
				//Menu
					...
					//Assertion
				      ...
				      FileUtils.copyFile(screenshot3, new File(".//ScreenShots//OP_Patient_Self_Refund_Against_Account_Page_OPPatientDepositPayementforRefund.png"));
				      Thread.sleep(3000);
   ...
   //----Refund----//
					...
					//CreatedMRN
					  Thread.sleep(3000);
					  WebElement AvailableBal=driver.findElement(AvailableBalance);
					  String Available=AvailableBal.getText();
					...
					Thread.sleep(2000);
					driver.findElement(RefundAmount).click();
					Thread.sleep(2000);
					driver.findElement(RefundAmount).sendKeys(Available);
					...
					//Assertions
					 Thread.sleep(1000);
				      ...
				      FileUtils.copyFile(screenshot4, new File(".//ScreenShots//OP_Patient_Self_Refund_Against_Account_Page_OP Patient Refund Collected.png"));
				      Thread.sleep(3000);
