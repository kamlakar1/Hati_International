...
public class Debit_Note_Final_Bill_Partial_Settlement {
...

	{
		...
		FileUtils.copyFile(screenshot, new File(".//ScreenShots//Debit_Note_Final_Bill_Partial_Settlement_QuickRegisterationForm.png")); 
		...
		FileUtils.copyFile(screenshot1, new File(".//ScreenShots//Debit_Note_Final_Bill_Partial_Settlement_EncounterListScreen.png")); 
