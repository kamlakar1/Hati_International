...
public class OP_Reg_InsuranceADT_OP_to_IP_convert_save_admission_GL_Approval_IP_charge_IPD_Bill_Apply_Group_Discount 
{
	WebDriver driver;
	...
	public void TC_05_Verify_User_Can_DO_GL_Approval_For_IP_Charges_And_IPD_BILL_Apply_Group_Discount(String PolicyNoPar,String PolicyDatePar,String HolderNamePar,String CustomerNamePar,String GLRefNOPar,String GLDatePar,String ExpiryDatePar,String GLAmountPar,String CoverageAmountPar,String ContactNamePar,String DesignationPar,String ContactNoPar,String GLRemarksPar) throws InterruptedException, IOException
	{
		BillingPages_2.GLApproval_ADT_Requested_FOR_IP_Charge_IP_BILL_Apply_GRoupDiscount GLIPChargesipbill=new BillingPages_2.GLApproval_ADT_Requested_FOR_IP_Charge_IP_BILL_Apply_GRoupDiscount(driver);
		GLIPChargesipbill.GLApprovalForADT_Req_GL_Approval_IPCharges_IPBILL_Apply_GRoup_Discount(PolicyNoPar,PolicyDatePar,HolderNamePar,CustomerNamePar,GLRefNOPar,GLDatePar,ExpiryDatePar,GLAmountPar,CoverageAmountPar,ContactNamePar,DesignationPar,ContactNoPar,GLRemarksPar);	 
	}
	@BeforeTest
	public void beforeTest() throws InterruptedException, ATUTestRecorderException 
	{
		recorder = new ATUTestRecorder(".//Videos//","OP_Reg_InsuranceADT_OP_to_IP_convert_save_admission_GL_Approval_IP_charge_IPD_Bill_Apply_Group_Discount"+dateFormat.format(date),false);
		recorder.start();
	...
	public void FailedScreenShot(ITestResult Result) throws IOException
	{
		if(ITestResult.FAILURE==Result.getStatus())
		{
			...
			FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//Failure_OP_Reg_InsuranceADT_OP_to_IP_convert_save_admission_GL_Approval_IP_charge_IPD_Bill_Apply_Group_Discount"+ dateFormat.format(date)));
		}
	}
	@AfterSuite
