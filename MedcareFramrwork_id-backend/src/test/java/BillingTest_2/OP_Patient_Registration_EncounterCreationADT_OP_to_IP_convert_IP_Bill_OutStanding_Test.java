...
public class OP_Patient_Registration_EncounterCreationADT_OP_to_IP_convert_IP_Bill_OutStanding_Test 
{
	...
	@Test(priority=2)
	 ...
	 @Test(priority=5)
		public void TC_05_Verify_That_User_Is_Able_to_Add_IP_Charges_For_Patient() throws InterruptedException, IOException
		{
		 BillingPages_2.IP_Bill_For_Self_OutStanding ip=new BillingPages_2.IP_Bill_For_Self_OutStanding(driver);
		 ip.IPDBillForSelPayerOutStanding();
		}
	@BeforeTest
	...
	public void FailedScreenShot(ITestResult Result) throws IOException
	{
		if(ITestResult.FAILURE==Result.getStatus())
		{
			...
			FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//Failure_OP_Patient_Registration_EncounterCreationADT_OP_to_IP_convert_IP_Bill_Test"+ dateFormat.format(date)));
		}
	}
	@AfterSuite
