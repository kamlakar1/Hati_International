...
public class OPD_Reg_Encounter_ADT_OP_TO_IP_COnvert_Add_Deposit_Add_Against_Account_Refund_AMT 
{
	...
	@Test(priority=5)
	public void TC_05_Verify_Taht_User_is_Able_To_Add_Deposit_Against_Patient_And_Refund_Amount() throws InterruptedException, IOException 
	{
		BillingPages_2.ADT_Admission_Form_save_Admission_Deposit_Add_Against_Account_Save_Refund OPTOIPRefund=new BillingPages_2.ADT_Admission_Form_save_Admission_Deposit_Add_Against_Account_Save_Refund(driver);
		OPTOIPRefund.OP_TO_IP_Patient_Deposit_Add_Agains_Account_Save_Refund();	  
	} 
	@BeforeTest
	public void beforeTest() throws InterruptedException, ATUTestRecorderException 
	{
		recorder = new ATUTestRecorder(".//Videos//","OPD_Reg_Encounter_ADT_OP_TO_IP_COnvert_Add_Deposit_Add_Against_Account_Refund_AMT"+dateFormat.format(date),false);
		recorder.start();
	...
	public void FailedScreenShot(ITestResult Result) throws IOException
	{
		if(ITestResult.FAILURE==Result.getStatus())
		{
			...
			FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//Failure_OPD_Reg_Encounter_ADT_OP_TO_IP_COnvert_Add_Deposit_Add_Against_Account_Refund_AMT"+ dateFormat.format(date)));
		}
	}
	@AfterSuite
