...
public class Admission_Request_AdmissionForm_save_Admission_IP_charge_Save_Charges_IP_Bill_Full_SettlementOutstanding 
{
	...
	@Test(priority=5)
	public void TC_05_Verify_That_User_Is_Able_to_Save_IP_Charges_Then_Create_IP_BILL_Outstanding_For_Patient() throws InterruptedException, IOException
	{
		BillingPages_2.ADTRequestedForm_IPcharge_SaveCharges_IP_Bill_Full_Settlement_Outstanding  ip=new BillingPages_2.ADTRequestedForm_IPcharge_SaveCharges_IP_Bill_Full_Settlement_Outstanding (driver);
		ip.IPCharges_IPD_BIll_Outstanding();
	}
	@BeforeTest
	public void beforeTest() throws InterruptedException, ATUTestRecorderException 
	{
		recorder = new ATUTestRecorder(".//Videos//","Admission_Request_AdmissionForm_save_Admission_IP_charge_Save_Charges_IP_Bill_Full_SettlementOutstanding-"+dateFormat.format(date),false);
		recorder.start();
	...
	public void FailedScreenShot(ITestResult Result) throws IOException
	{
		if(ITestResult.FAILURE==Result.getStatus())
		{
			...
			FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//Failure_Admission_Request_AdmissionForm_save_Admission_IP_charge_Save_Charges_IP_Bill_Full_SettlementOutstanding.png"+ dateFormat.format(date)));
		}
	}
	@AfterSuite
