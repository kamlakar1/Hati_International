...
public class OPD_Reg_Encounter_ADT_OP_TO_IP_Deposit_Add_Against_Patient 
{
	...
	@Test(priority=2)
	 ...
	 @Test(priority=5)
		public void TC_05_Verify_Taht_User_is_Able_To_Add_Deposit_Against_Patient() throws InterruptedException, IOException 
	{
		BillingPages_2.ADT_AdmissionForm_save_Admission_Deposit_Add_against_patient_Save IPchargeScreen=new BillingPages_2.ADT_AdmissionForm_save_Admission_Deposit_Add_against_patient_Save(driver);
		IPchargeScreen.IPD_Patient_Deposit_Self ();	  
	} 
