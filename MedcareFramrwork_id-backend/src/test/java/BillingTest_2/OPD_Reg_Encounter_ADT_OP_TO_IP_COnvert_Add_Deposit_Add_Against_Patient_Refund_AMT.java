...
public class OPD_Reg_Encounter_ADT_OP_TO_IP_COnvert_Add_Deposit_Add_Against_Patient_Refund_AMT 
{
	...
	{
		 BillingPages_2.ADT_Admission_Form_save_Admission_Deposit_Add_Against_Patient_Save_Refund IPchargeScreen=new BillingPages_2.ADT_Admission_Form_save_Admission_Deposit_Add_Against_Patient_Save_Refund(driver);
		IPchargeScreen.IPD_Patient_Deposit_Add_Agains_Patient_Save_Refund();	  
	} 
	
	@BeforeTest
	public void beforeTest() throws InterruptedException, ATUTestRecorderException 
	{
		recorder = new ATUTestRecorder(".//Videos//","OPD_Reg_Encounter_ADT_OP_TO_IP_COnvert_Add_Deposit_Add_Against_Patient_Refund_AMT"+dateFormat.format(date),false);
		recorder.start();
	...
	public void FailedScreenShot(ITestResult Result) throws IOException
	{
		if(ITestResult.FAILURE==Result.getStatus())
		{
			...
			FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//Failure_OPD_Reg_Encounter_ADT_OP_TO_IP_COnvert_Add_Deposit_Add_Against_Patient_Refund_AMT"+ dateFormat.format(date)));
		}
	}
	@AfterSuite
