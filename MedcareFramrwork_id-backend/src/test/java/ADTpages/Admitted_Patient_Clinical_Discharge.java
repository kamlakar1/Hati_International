...
public class Admitted_Patient_Clinical_Discharge 
{
  ...
  
  {
    ...
    //Save
      ...
      FileUtils.copyFile(screenshot11, new File(".//ScreenShots//NewAdmissionWithVIPPatient_NewIC_MandatoryField.png"));
      Thread.sleep(3000);
    ...
    FileUtils.copyFile(screenshot12, new File(".//ScreenShots//NewAdmissionWithVIPPatient_NewIC_MandatoryFieldAdmissionform.png"));
    Thread.sleep(3000);
	    ...
	    //CurrentTIme 
	      ...
	      //Condition10
	        ...
	        //ScreenShot1
		      ...
		      Assert.assertEquals(Actual_5, Expected_6, "Clinical Discharged Updated Successfully");
