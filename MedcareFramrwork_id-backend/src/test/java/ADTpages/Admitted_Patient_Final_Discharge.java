...
public class Admitted_Patient_Final_Discharge 
{
	...
	By mainmenuADTScreen=By.cssSelector("mat-icon[ng-reflect-message='Menu']");
		...
		//----Billing---//
			    ...
			    //BillIcon 
			    By BillIconClick=By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-admission-dashboard/mat-drawer-container/mat-drawer-content/div/table/tbody/tr[1]/td[1]/mat-icon");
			    
			    //IsFinalBill
			    By FinalBillCheckBox=By.cssSelector("mat-checkbox[id='Final Bill']");
			    
			    //BillSave
			    By BillSave=By.cssSelector("mat-icon[ng-reflect-message='Save']");
			    ...
			    //FinalDischarge 
			    By FinalDischarge=By.cssSelector("img[ng-reflect-message='Final Discharge']");
			    
			    //FinalRemarks 
			    By FinalRemarks=By.cssSelector("textarea[id='mat-input-8']");
			    
			    //FinalDischaregSave 
			    By FinalDischargeSave=By.cssSelector("button[ng-reflect-message='Save']");
			    
			    //AllRadioButton
			    By AllRadioButton=By.cssSelector("mat-radio-button[ng-reflect-value='All']");
  ...
  
  {
    ...
    //Save
      ...
      Assert.assertEquals(Actual_2, Expected_2, "Registartion Mandatory Field highlighting and Assertion Passed");
    ...
    String timestamp12= new SimpleDateFormat("yyyy_MM_dd__hh_mm_ss").format(new Date());
    FileUtils.copyFile(screenshot3, new File(".//ScreenShots//NewAdmissionWithVIPPatient_NewIC_MandatoryFieldAdmissionform.png"));
    Thread.sleep(3000);
  	
      String Actual_3 = "Please fill all mandatory fields";
      String Expected_3 = "Please fill all mandatory fields";
      Assert.assertEquals(Actual_1, Expected_1, "Admission Mandatory Field highlighting and Assertion Passed");
...
*/
		    ...
		    //CurrentTIme 
		      ...
		      //Condition10
		        ...
		        //ScreenShot1
			     ...
			     //BillIcon
			      Thread.sleep(5000);
			      driver.findElement(BillIconClick).click();
			      Thread.sleep(15000);
			      ...
			      //IsFinalBill
			      Thread.sleep(10000);
			      driver.findElement(FinalBillCheckBox).click();
			      
			      //BillSave 
			      Thread.sleep(3000);
			      driver.findElement(BillSave).click();
			      ...
			      //TabSwitch
				  Thread.sleep(5000);
			      String windowHandle33 = driver.getWindowHandle();
				...
				//PatientClick
			      ...
			      //FinalDischarge
			     Thread.sleep(3000);
			     driver.findElement(FinalDischarge).click();
			     
			     //FinalRemarks
			     Thread.sleep(3000);
			     driver.findElement(FinalRemarks).sendKeys("Testing");
			     
			     //FinalDischaregSave
			     Thread.sleep(3000);
			     driver.findElement(FinalDischargeSave).click();
			     
			     //AllRadioButton
			     Thread.sleep(3000);
			     driver.findElement(AllRadioButton).click();
			     
			       
			     //Assertion
				  String Actual_5 = "Discharged";
			      String Expected_6 = "Discharged";
			      Assert.assertEquals(Actual_5, Expected_6, "Admission Discharged Susccefully");
			      ...
			      FileUtils.copyFile(screenshot44, new File(".//ScreenShots//NewAdmissionFinalDischarge_Status.png"));
			      Thread.sleep(3000);
  ...
  public Admitted_Patient_Final_Discharge(WebDriver driver)
