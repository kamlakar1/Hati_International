...
public class NewAdmissionWithVIPPatient_Passport 
{
...
By mainmenuADTScreen=By.cssSelector("mat-icon[ng-reflect-message='Menu']");
  ...
  public void AdmissionWithVIPPatient(String PriNumberPar,String PatientNamePar,String ExpiryDatePar,String DOBPar,String MobilePar,String EmailPar,String LengthPar,String NotesPar,String RemarksPar,String RegAddressPar,String LengthOfStayPar,String AdmittingDiagPar,String AddNotesPar,String PatientNotesPar,String AdmissionRemarksPar,String BillEstimationPar,String ReferralRemarksPar,String NamePar,String IdentificationNOPar,String PhoneNumberPar,String AddressPar,String ZipCodePar) throws InterruptedException, IOException 
  {
	...
	//ScreenShot2
	  ...
	  //Assertion
	  String Actual_1 = "Passport";
      String Expected_1 = "Passport";
      Assert.assertEquals(Actual_1, Expected_1,"Passport PrimaryID Selected Successfully Assertion Passed");
     
      Thread.sleep(1000);
      File screenshot3 = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
      String timestamp3= new SimpleDateFormat("yyyy_MM_dd__hh_mm_ss").format(new Date());
      FileUtils.copyFile(screenshot3, new File(".//ScreenShots//NewAdmissionWithVIPPatient_PassportPrimaryID.png"));
      Thread.sleep(3000);
	...
	//ScreenShot3
      ...
      FileUtils.copyFile(screenshot13,new File(".//ScreenShots//CreatedRequest.png"));
    ...
    //ScreenShot4
      ...
      FileUtils.copyFile(screenshot4,new File(".//ScreenShots//RegistrationScreen.png"));
     ...
     //VIPPatient 
      ...
      String timestamp14= new SimpleDateFormat("yyyy_MM_dd__hh_mm_ss").format(new Date());
      FileUtils.copyFile(screenshot3, new File(".//ScreenShots//NewAdmissionWithVIPPatient_Passport_RegMandatoryField.png"));
      Thread.sleep(3000);
    ...
    //Condition5
      Thread.sleep(5000);
      if(driver.getPageSource().contains("General Information")&& (driver.getPageSource().contains("VIP")))
    ...
    //Clicking on save button	
      ...
      FileUtils.copyFile(screenshot3, new File(".//ScreenShots//NewAdmissionWithVIPPatient_Passport_MandatoryFieldAdmissionform.png"));
      Thread.sleep(3000);
...
*/
	...
	//Get the list of window handles
      ...
      if(driver.getPageSource().contains(PatientName))
      {
    	  System.out.println("Admission Dashboard Appear and Patient Displayed");
      }
      else
      {
	    ...
	    //ScreenShot7
	      ...
	      FileUtils.copyFile(screenshot7,new File(".//ScreenShots//AdmissionCreated.png"));
	  ...
	  public NewAdmissionWithVIPPatient_Passport (WebDriver driver)
