...
WebDriver driver=null;
  ...
  public void AdmissionWithVIPPatientOldIC(String PriNumberPar,String PatientNamePar,String ExpiryDatePar,String DOBPar,String MobilePar,String EmailPar,String LengthPar,String NotesPar,String RemarksPar,String RegAddressPar,String LengthOfStayPar,String AdmittingDiagPar,String AddNotesPar,String PatientNotesPar,String AdmissionRemarksPar,String BillEstimationPar,String ReferralRemarksPar,String NamePar,String IdentificationNOPar,String PhoneNumberPar,String AddressPar,String ZipCodePar) throws InterruptedException, IOException 
  {
	...
	//ScreenShot2
      ...
      FileUtils.copyFile(screenshot3, new File(".//ScreenShots//NewAdmissionWithVIPPatient_OldICPrimaryID.png"));
      Thread.sleep(3000);
      
	  //Assertion
	  String Actual_1 = "Old IC";
      String Expected_1 = "Old IC";
      Assert.assertEquals(Actual_1, Expected_1, "OldIC PrimaryID Selected Successfully Assertion Passed");
	...
	//ScreenShot3
      ...
      FileUtils.copyFile(screenshot11,new File(".//ScreenShots//CreatedRequest.png"));
    ...
    //ScreenShot4
     ...
     //VIPPatient 
      ...
      FileUtils.copyFile(screenshot3, new File(".//ScreenShots//NewAdmissionWithVIPPatient_OldIC_RegiMandatoryField.png"));
     
      Thread.sleep(8000);
	  
      //Assertion
	  String Actual_2 = "General Information";
      String Expected_2 = "No Patient Selected";
    ...
    Thread.sleep(1000);
      ...
      String timestamp13= new SimpleDateFormat("yyyy_MM_dd__hh_mm_ss").format(new Date());
      FileUtils.copyFile(screenshot13, new File(".//ScreenShots//NewAdmissionWithVIPPatient_NewIC_MandatoryFieldAdmissionform.png"));
      Thread.sleep(3000);
    	
        String Actual_3 = "Please fill all mandatory fields";
        String Expected_3 = "Please fill all mandatory fields";
        Assert.assertEquals(Actual_3, Expected_3, "Admission Mandatory Field highlighting and Assertion Passed");
