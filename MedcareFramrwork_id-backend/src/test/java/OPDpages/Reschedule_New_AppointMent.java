...
public class Reschedule_New_AppointMent {
	...
	public Reschedule_New_AppointMent(WebDriver driver) {
		this.driver= driver;
...
//String fromDateRangeA,String toDateRangeA, 
	...
	//	driver.findElement(toDateRange).sendKeys(toDateRangeA);
		...
		FileUtils.copyFile(screenshot, new File(".//ScreenShots//book_new_appointment_for_rescheduling.png"));
