...
public class BookedexistingAppointment {
	...
	public void Appointmentarrivedfunc() throws InterruptedException, AWTException, IOException {
		...
		FileUtils.copyFile(screenshot, new File(".//ScreenShots//Department_existing_appoint_booked.png"));

		if(driver.getPageSource().contains("Booked")) 
		{
			System.out.println("Department Existing:- appointment has been booked successfully"); 
		} else 
		{
			System.out.println("Department Existing:- appointment is not Booked"); 
		}
		Thread.sleep(700);
