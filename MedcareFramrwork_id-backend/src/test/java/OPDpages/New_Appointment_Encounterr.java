...
public class New_Appointment_Encounterr {
	...
	public New_Appointment_Encounterr(WebDriver driver) {
		this.driver= driver;
	}
	...
	public void Encounter(String EncounterRemarksPar,String AddNotesPar,String NamePar,String IdentificationNOPar,String PhoneNoPar,String AddressPar,String PostcodeParAdetailsPar) throws InterruptedException, IOException, AWTException
	{
		...
		{
			System.out.println("Checkin for new appointment has been redirected to the  Encounter Details page and appointmet is arrived"); 
		} else 
		{
			System.out.println("Redirecting to the Encounter Details page for new appointment failed"); 
		}
...
driver.findElement(CityNSelOpt).click();*/
		...
		FileUtils.copyFile(screenshot2, new File(".//ScreenShots//Uploaddocs.png"));
		...
		FileUtils.copyFile(screenshot3, new File(".//ScreenShots//OpdRegusterationEncounter.png"));
