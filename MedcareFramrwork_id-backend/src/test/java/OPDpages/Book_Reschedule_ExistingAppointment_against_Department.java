...
public class Book_Reschedule_ExistingAppointment_against_Department {
	...
	By Appointmentmain = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/ng-sidebar/aside/app-sidebar/app-menu/ul/li[2]/a/span[1]");
	...
	public Book_Reschedule_ExistingAppointment_against_Department(WebDriver driver) {
		this.driver= driver;
	...
	public void ExitingAppontmetfunc(String AppointmenttypeA, String consultationA, String specialityA, String EmailA, String WorkcontctA, String HomecontactA, String RemarksA) throws InterruptedException, AWTException, IOException {
		...
		Thread.sleep(3000);
		driver.findElement(Appointmentmain).click();
		Thread.sleep(3000);
