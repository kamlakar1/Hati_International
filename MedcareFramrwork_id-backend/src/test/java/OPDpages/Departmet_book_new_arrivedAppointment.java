...
public class Departmet_book_new_arrivedAppointment {
	...
	public Departmet_book_new_arrivedAppointment(WebDriver driver) {
		this.driver= driver;
	...
	public void Appointmentarrivedfunc() throws InterruptedException, AWTException, IOException {
		...
		if(driver.getPageSource().contains("Arrived")) 
		{
			System.out.println("Booked new appointment status has been changed to Arrived succesfully"); 
		} else 
		{
			System.out.println("Booked new appointment status not changed to Arrived"); 
		}
		File screenshot = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
		FileUtils.copyFile(screenshot, new File(".//ScreenShots//New_appointment_department_AppointmentArrived.png"));
