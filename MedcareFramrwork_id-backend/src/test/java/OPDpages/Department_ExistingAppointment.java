...
public class Department_ExistingAppointment {
	...
	By APPOINTMENTt = By.cssSelector("a[id='2001']");
	...
	//By Selectappointment_1 = By.cssSelector("background-color: rgb(182, 236, 182)");
	
	
	
	
	public Department_ExistingAppointment(WebDriver driver) {
		this.driver= driver;
	...
	public void ExitingAppontmetfunc(String AppointmenttypeA, String consultationA, String specialityA,String EmailA, String WorkcontctA, String HomecontactA, String RemarksA) throws InterruptedException, AWTException, IOException {
		...
		Thread.sleep(4000);
		driver.findElement(APPOINTMENTt).click();
		Thread.sleep(2000);
		...
		{
			System.out.println("Department existing:- OPD > Appointment > Appointment page has been launched successfully"); 
		} else 
		{
			System.out.println(" Department existing:- OPD > Appointment > Appointment failed"); 
		}
		...
		Thread.sleep(2000);
		File screenshot = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
		FileUtils.copyFile(screenshot, new File(".//ScreenShots//Department_existing_appoint.png"));
