...
public class Book_NewAppointMent_against_doctor {
	...
	public Book_NewAppointMent_against_doctor(WebDriver driver) {
		this.driver= driver;
	...
	public void NewAppontmetfunc(String AppointmenttypeA, String consultationA,String specialityA, String passportA,String PrimeryIDNumberA,String ExpiryDateA,String TitleoptA,String GendesendA,String dateOfBirthA,String addressA,String countryPrimaryA,String stateA,String CityA,String postA,String CountryCodeA,String AreaA,String mobileNumberA,String workcontactnoA,String homecontactnoA,String emailA) throws InterruptedException, AWTException {
		...
		Thread.sleep(900);
		//	driver.findElement(toDateRange).sendKeys(toDateRangeA);
		Thread.sleep(900);
		...
		Thread.sleep(900);
		//driver.findElement(needviptratment).click();
		Thread.sleep(900);
		...
		String Actualappoint = "Do you want to proceed?";
		String Expectedappoint = "Do you want to proceed?";
		Assert.assertEquals(Actualappoint, Expectedappoint, "Yes button is not visible to proceed?");
