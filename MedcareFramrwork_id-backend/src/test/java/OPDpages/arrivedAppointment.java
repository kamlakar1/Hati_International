...
public class arrivedAppointment {
	...
	By Expand = By.cssSelector("mat-icon[ng-reflect-message='Collapse']");
	...
	public arrivedAppointment(WebDriver driver) {
		this.driver= driver;
	...
	public void Appointmentarrivedfunc() throws InterruptedException, AWTException, IOException {
		...
		FileUtils.copyFile(screenshot, new File(".//ScreenShots//AppointmentArrived.png"));
