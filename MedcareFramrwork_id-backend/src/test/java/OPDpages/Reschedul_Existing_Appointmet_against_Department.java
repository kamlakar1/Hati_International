...
public class Reschedul_Existing_Appointmet_against_Department {
	...
	public Reschedul_Existing_Appointmet_against_Department(WebDriver driver) {
		this.driver= driver;

	}

	public void Resheduleappointmetfunc() throws InterruptedException, AWTException, IOException {
    ...
    /*
		...
		*/
		...
		FileUtils.copyFile(screenshot1, new File(".//ScreenShots//Filling_details_for_Existing_appointment_reschedule.png"));
		Thread.sleep(8000);
		...
		FileUtils.copyFile(screenshot, new File(".//ScreenShots//Existing_Appointment_Rescheduled.png"));
		Thread.sleep(4000);
