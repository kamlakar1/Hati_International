...
public class RescheduleAppointment {
	...
	public RescheduleAppointment(WebDriver driver) {
		this.driver= driver;
	...
	public void Resheduleappointmetfunc(String selectgender) throws InterruptedException, AWTException, IOException {
		...
		FileUtils.copyFile(screenshot1, new File(".//ScreenShots//Filling_details_for_appointment_reschedule.png"));
		Thread.sleep(8000);
		...
		FileUtils.copyFile(screenshot, new File(".//ScreenShots//AppointmentRescheduled.png"));
		Thread.sleep(4000);
