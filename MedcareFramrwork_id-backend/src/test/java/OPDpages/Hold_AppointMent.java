...
public class Hold_AppointMent {
    ...
    By Yes =By.cssSelector("mat-icon[ng-reflect-message='Yes']");
    public Hold_AppointMent(WebDriver driver) {
		this.driver= driver;
...
//String fromDateRangeA,String toDateRangeA, 
	...
	//	Thread.sleep(900);
		...
		Thread.sleep(4000);
		driver.findElement(HoldAppointment).click();
		Thread.sleep(4000);
		driver.findElement(Selectappointment).click();
		Thread.sleep(4000);
		Thread.sleep(2000);
		File screenshot = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
		FileUtils.copyFile(screenshot, new File(".//ScreenShots//Hold_Appointment.png"));
		Thread.sleep(2000);
		...
		{
			System.out.println("Appointment has been confirmed and HOLD successfully"); 
		} else 
		{
			System.out.println("Appointment has been failed to HOLD"); 
		}
		Thread.sleep(4000);
		File screenshot1 = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
		FileUtils.copyFile(screenshot1, new File(".//ScreenShots//Select_Reason_Hold_Appointment.png"));
		Thread.sleep(1000);
